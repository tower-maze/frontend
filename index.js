    ...
    for (let y = 0; y < 32; y++) {
      for (let x = 0; x < 32; x++) {
        ...
        if (connectionCount === 2) {
          if (room.n && room.s) mazeContext.drawImage(sprites, 16 * 4, 0, 16, 16, 16 * x, 16 * y, 16, 16);
          if (room.e && room.w) mazeContext.drawImage(sprites, 16 * 5, 0, 16, 16, 16 * x, 16 * y, 16, 16);
          if (room.s && room.e) mazeContext.drawImage(sprites, 16 * 6, 0, 16, 16, 16 * x, 16 * y, 16, 16);
          if (room.e && room.n) mazeContext.drawImage(sprites, 16 * 7, 0, 16, 16, 16 * x, 16 * y, 16, 16);
          if (room.n && room.w) mazeContext.drawImage(sprites, 16 * 8, 0, 16, 16, 16 * x, 16 * y, 16, 16);
          if (room.s && room.w) mazeContext.drawImage(sprites, 16 * 9, 0, 16, 16, 16 * x, 16 * y, 16, 16);
        }
        if (connectionCount === 3) {
          if (room.w && room.s && room.e) mazeContext.drawImage(sprites, 16 * 10, 0, 16, 16, 16 * x, 16 * y, 16, 16);
          if (room.s && room.e && room.n) mazeContext.drawImage(sprites, 16 * 11, 0, 16, 16, 16 * x, 16 * y, 16, 16);
          if (room.e && room.n && room.w) mazeContext.drawImage(sprites, 16 * 12, 0, 16, 16, 16 * x, 16 * y, 16, 16);
          if (room.n && room.w && room.s) mazeContext.drawImage(sprites, 16 * 13, 0, 16, 16, 16 * x, 16 * y, 16, 16);
        }
